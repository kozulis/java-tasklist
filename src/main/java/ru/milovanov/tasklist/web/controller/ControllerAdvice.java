...
import ru.milovanov.tasklist.domain.exception.ExceptionBody;
...
public class ControllerAdvice {
    ...
    public ExceptionBody handleRosourceNotFound(ResourceNotFoundException e) {
        return new ExceptionBody(e.getMessage());
    }

    @ExceptionHandler(ResourceMappingException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ExceptionBody handleRosourceMapping(ResourceMappingException e) {
        return new ExceptionBody(e.getMessage());
    }
