...
import ru.milovanov.tasklist.repository.mappers.UserRowMapper;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    public Optional<User> findById(Long id) {
        try {
            ...
            throw new ResourceMappingException("Exception while find user by id.");
        }
    }
    ...
    public Optional<User> findByUsername(String username) {
        try {
            ...
            throw new ResourceMappingException("Exception while find user by username.");
        }
    }
    ...
    public void create(User user) {
        try {
            ...
            throw new ResourceMappingException("Exception while creat user.");
        }
    }
    ...
    public boolean isTaskOwner(Long userId, Long taskId) {
        try {
            ...
            throw new ResourceMappingException("Exception while check if user is task owner.");
        }
    }
